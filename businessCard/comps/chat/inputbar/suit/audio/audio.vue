<template>
		<!-- :style="{bottom:parseInt(isBootomHeight/15) + 'px'}" -->
		<view  v-if="recordStatus != RecordStatus.HIDE"  class="modal-record"  >
			{{parseInt(isBootomHeight/15)}}
			<view class="modal-body" @tap.stop="toggleWithoutAction">
				...
				<view class="dot" @touchstart="handleRecording" @touchmove="handleRecordingMove"
