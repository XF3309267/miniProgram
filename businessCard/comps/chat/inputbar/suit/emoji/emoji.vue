<template>
<swiper :class="show" :style="{height:fixedBottomHeight?(fixedBottomHeight +'px' ):0 }" :indicator-dots="indicatorDots" :autoplay="autoplay" :interval="interval" :duration="duration">
	<block>
		<swiper-item>
