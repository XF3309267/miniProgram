<template>
	<view class="person-contain">
		...
		<view v-if="userType === 1" class="" id="personCardTitle">
			<view class=" flex justify-between padding-sm" style="height: 100rpx;">
				<text class="  text-lg text-bold"> 我的名片 </text> 
				<text> 修改 <text class="cuIcon-right"> </text> </text>
			</view>
			<salesManagerCard  id="personSalesCard" />
		</view>
		...
		<block v-for="(item,index) in list" :key="index" style="position: sticky;" >
...
<script>
	...
	export default {
		...
		mounted() {
			console.log(pinyin("了了了了了了那就是都可参加u时代后即可"))
			let me = this;
			   ...
			   query.exec(function (res) {
			    console.log(res);
			    var miss = res[0].scrollTop + 770 - 10;
			    uni.pageScrollTo({
			     scrollTop: miss,
			     duration: 300
			    });
